        ...
        child: Stack(
          children:[
            Container(
              child: ListView(
                children: [
                  ...
                  const ItemNama(isMe: true, name: 'Stephen Strange (Me)',),
                  const SizedBox(
                    height: 10,
                  ),
                  const ItemNama(isMe: false, name: 'Tommy Bong',),
                  const SizedBox(
                    height: 10,
                  ),
                  const ItemNama(isMe: false, name: 'Wanda Maximoff',),
                  const SizedBox(
                    height: 10,
                  ),
                  const ItemNama(isMe: false, name: 'Tony Stark',),
                  const SizedBox(
                    height: 34,
                  ),
                  Padding(
            ...
            Column(
              ...
              children: [
                BaseButton(ontap: (){}, text: "CONTINUE", color: OTextsecondaryColor, outlineRadius: 0,)
              ],
            )
          ] 
        ),
...
class ItemNama extends StatefulWidget {
  ...
  final bool isMe;
  const ItemNama({
    Key? key, required this.name, required this.isMe,
  }) : super(key: key);
